...
class Doutos extends MY_Controller
{
    ...
    public function index()
    {
        ...
        $this->data['ordens_status'] = $this->doutos_model->getOsStatus($status);
        $vstatus = ['Aberto', 'Em Andamento', 'Aguardando Peças', 'Aprovado', 'Orçamento'];
        $this->data['vendasstatus'] = $this->doutos_model->getVendasStatus($vstatus);
        $this->data['lancamentos'] = $this->doutos_model->getLancamentos();
        $this->data['ordens_orcamentos'] = $this->doutos_model->getOsOrcamentos();
        $this->data['ordens_abertas'] = $this->doutos_model->getOsAbertas();
        $this->data['ordens_aprovadas'] = $this->doutos_model->getOsAprovadas();
        $this->data['ordens_finalizadas'] = $this->doutos_model->getOsFinalizadas();
        $this->data['ordens_aguardando'] = $this->doutos_model->getOsAguardandoPecas();
        $this->data['ordens_andamento'] = $this->doutos_model->getOsAndamento();
        $this->data['produtos'] = $this->doutos_model->getProdutosMinimo();
        $this->data['os'] = $this->doutos_model->getOsEstatisticas();
        $this->data['estatisticas_financeiro'] = $this->doutos_model->getEstatisticasFinanceiro();
        $this->data['financeiro_mes_dia'] = $this->doutos_model->getEstatisticasFinanceiroDia($this->input->get('year'));
        $this->data['financeiro_mes'] = $this->doutos_model->getEstatisticasFinanceiroMes($this->input->get('year'));
        $this->data['financeiro_mesinadipl'] = $this->doutos_model->getEstatisticasFinanceiroMesInadimplencia($this->input->get('year'));
        $this->data['menuPainel'] = 'Painel';
        $this->data['view'] = 'doutos/painel';
    ...
    {
        $this->data['usuario'] = $this->doutos_model->getById($this->session->userdata('id_admin'));
        $this->data['view'] = 'doutos/minhaConta';
    ...
    {
        $current_user = $this->doutos_model->getById($this->session->userdata('id_admin'));

        if (!$current_user) {
            $this->session->set_flashdata('error', 'Ocorreu um erro ao pesquisar usuário!');
            redirect(site_url('doutos/minhaConta'));
        }
        ...
        $result = $this->doutos_model->alterarSenha($senha);
    ...
    public function pesquisar()
    {
        ...
        $data['results'] = $this->doutos_model->pesquisar($termo);
        $this->data['produtos'] = $data['results']['produtos'];
        $this->data['servicos'] = $data['results']['servicos'];
        $this->data['os'] = $data['results']['os'];
        $this->data['clientes'] = $data['results']['clientes'];
        $this->data['view'] = 'doutos/pesquisa';
    ...
    public function emitente()
    {
        ...
        $this->data['dados'] = $this->doutos_model->getEmitente();
        $this->data['view'] = 'doutos/emitente';
    ...
    public function cadastrarEmitente()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            redirect(site_url('doutos/emitente'));
        } else {
            ...
            $retorno = $this->doutos_model->addEmitente($nome, $cnpj, $ie, $cep, $logradouro, $numero, $bairro, $cidade, $uf, $telefone, $email, $logo);
            if ($retorno) {
    ...
    public function editarEmitente()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $retorno = $this->doutos_model->editEmitente($id, $nome, $cnpj, $ie, $cep, $logradouro, $numero, $bairro, $cidade, $uf, $telefone, $email);
            if ($retorno) {
    ...
    public function editarLogo()
    {
        ...
        $retorno = $this->doutos_model->editLogo($id, $logo);
        if ($retorno) {
            $this->session->set_flashdata('success', 'As informações foram alteradas com sucesso.');
    ...
    public function uploadUserImage()
    {
        ...
        $usuario = $this->doutos_model->getById($id);
        ...
        $imageUserPath = $image;
        $retorno = $this->doutos_model->editImageUser($id, $imageUserPath);
    ...
    public function emails()
    {
        ...
        $this->data['configuration']['base_url'] = site_url('doutos/emails/');
    ...
    public function excluirEmail()
    {
        ...
        if ($id == null) {
            ...
            redirect(site_url('doutos/emails/'));
        }
    ...
    public function atualizarBanco()
    {
        ...
        return redirect(site_url('doutos/configurar'));
    }
    ...
    public function calendario()
    {
        ...
        $allOs = $this->doutos_model->calendario(
            $start,
            $end,
            $status
        );
