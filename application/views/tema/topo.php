...
<head>
  <title><?= $configuration['app_name'] ?: 'DOUTOS' ?></title>
  <meta charset="UTF-8" />
...
<body>
      ...
      <ul class="nav">
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li class=""><a title="Meu Perfil" href="<?= site_url('doutos/minhaConta'); ?>"><span class="text">Meu Perfil</span></a></li>
            <li class="divider"></li>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="<?= site_url('doutos/configurar') ?>">Sistema</a></li>
            <li><a href="<?= site_url('usuarios') ?>">Usuários</a></li>
            <li><a href="<?= site_url('doutos/emitente') ?>">Emitente</a></li>
            <li><a href="<?= site_url('permissoes') ?>">Permissões</a></li>
            <li><a href="<?= site_url('auditoria') ?>">Auditoria</a></li>
            <li><a href="<?= site_url('doutos/emails') ?>">Emails</a></li>
            <li><a href="<?= site_url('doutos/backup') ?>">Backup</a></li>
          </ul>
        </li>
      </ul>
    </div>
      ...
      <section class="sec_profile">
        <div class="profile">
          <div class="profile-img">
            <a href="<?= site_url('doutos/minhaConta'); ?>"><img src="<?= !is_file(FCPATH . "assets/userImage/" . $this->session->userdata('url_image_user_admin')) ?  base_url() . "assets/img/User.png" : base_url() . "assets/userImage/" . $this->session->userdata('url_image_user_admin') ?>" alt=""></a>
          </div>
        </div>
      </section>
  ...
  <div style="display: none" id="search">
    <form action="<?= site_url('doutos/pesquisar') ?>">
